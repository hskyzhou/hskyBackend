	        ...
	        <div class="portlet light bordered">
	            ...
	            <div class="portlet-body">
	                <div id="site_statistics_loading">
	                    <img src="{{asset('themes/metronic/global/img/loading.gif')}}" alt="loading" /> </div>
	                        ...
	                        <div class="mt-comments">
	                            <div class="mt-comment">
	                                <div class="mt-comment-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar1.jpg')}}" /> </div>
	                            ...
	                            <div class="mt-comment">
	                                <div class="mt-comment-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar6.jpg')}}" /> </div>
	                                <div class="mt-comment-body">
	                                    <div class="mt-comment-info">
	                            ...
	                            <div class="mt-comment">
	                                <div class="mt-comment-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar8.jpg')}}" /> </div>
	                                <div class="mt-comment-body">
	                                    <div class="mt-comment-info">
	                            ...
	                            <div class="mt-comment">
	                                <div class="mt-comment-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar4.jpg')}}" /> </div>
	                                <div class="mt-comment-body">
	                                    <div class="mt-comment-info">
	                ...
	                <div class="tab-content">
	                        ...
	                        <div class="mt-actions">
	                            <div class="mt-action">
	                                <div class="mt-action-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar10.jpg')}}" /> </div>
	                            ...
	                            <div class="mt-action">
	                                <div class="mt-action-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar3.jpg')}}" /> </div>
	                                <div class="mt-action-body">
	                                    <div class="mt-action-row">
	                                        <div class="mt-action-info ">
	                                            <div class="mt-action-icon ">
	                            ...
	                            <div class="mt-action">
	                                <div class="mt-action-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar2.jpg')}}" /> </div>
	                                <div class="mt-action-body">
	                                    <div class="mt-action-row">
	                                        <div class="mt-action-info ">
	                                            <div class="mt-action-icon ">
	                            ...
	                            <div class="mt-action">
	                                <div class="mt-action-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar7.jpg')}}" /> </div>
	                                <div class="mt-action-body">
	                                    <div class="mt-action-row">
	                                        <div class="mt-action-info ">
	                                            <div class="mt-action-icon ">
	                            ...
	                            <div class="mt-action">
	                                <div class="mt-action-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar9.jpg')}}" /> </div>
	                                <div class="mt-action-body">
	                                    <div class="mt-action-row">
	                                        <div class="mt-action-info ">
	                                            <div class="mt-action-icon ">
	                    ...
	                    <div class="tab-pane" id="tab_actions_completed">
	                        ...
	                        <div class="mt-actions">
	                            ...
	                            <div class="mt-action">
	                                <div class="mt-action-img">
	                                    <img src="{{asset('themes/metronic/pages/media/users/avatar5.jpg')}}" /> </div>
	                                <div class="mt-action-body">
	                                    <div class="mt-action-row">
	                                        <div class="mt-action-info ">
	                                            <div class="mt-action-icon ">
	        ...
	        <div class="portlet light bordered">
	            ...
	            <div class="portlet-body" id="chats">
	                <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
	                    <ul class="chats">
	                        <li class="out">
	                            <img class="avatar" alt="" src="{{asset('themes/metronic/layouts/layout/img/avatar2.jpg')}}" />
	                            <div class="message">
	                        ...
	                        <li class="in">
	                            <img class="avatar" alt="" src="{{asset('themes/metronic/layouts/layout/img/avatar1.jpg')}}" />
	                            <div class="message">
	                                <span class="arrow"> </span>
	                        ...
	                        <li class="out">
	                            <img class="avatar" alt="" src="{{asset('themes/metronic/layouts/layout/img/avatar3.jpg')}}" />
	                            <div class="message">
	                                <span class="arrow"> </span>
	                ...
	                <div class="row">
	                    <div class="col-md-4">
	                        ...
	                        <div class="mt-widget-1">
	                            ...
	                            <div class="mt-img">
	                                <img src="{{asset('themes/metronic/pages/media/users/avatar80_8.jpg')}}"> </div>
	                            <div class="mt-body">
	                    ...
	                    <div class="col-md-4">
	                        ...
	                        <div class="mt-widget-1">
	                            ...
	                            <div class="mt-img">
	                                <img src="{{asset('themes/metronic/pages/media/users/avatar80_7.jpg')}}"> </div>
	                            <div class="mt-body">
	                    ...
	                    <div class="col-md-4">
	                        ...
	                        <div class="mt-widget-1">
	                            ...
	                            <div class="mt-img">
	                                <img src="{{asset('themes/metronic/pages/media/users/avatar80_6.jpg')}}"> </div>
	                            <div class="mt-body">
	                ...
	                <div class="row">
	                    <div class="col-md-6">
	                        <div class="mt-widget-2">
	                            <div class="mt-head" style="background-image: url({{asset('themes/metronic/pages/img/background/32.jpg')}});">
	                                <div class="mt-head-label">
	                                    <button type="button" class="btn btn-success">Manhattan</button>
	                                </div>
	                                <div class="mt-head-user">
	                                    <div class="mt-head-user-img">
	                                        <img src="{{asset('themes/metronic/pages/img/avatars/team7.jpg')}}"> </div>
	                    ...
	                    <div class="col-md-6">
	                        <div class="mt-widget-2">
	                            <div class="mt-head" style="background-image: url({{asset('themes/metronic/pages/img/background/43.jpg')}});">
	                                <div class="mt-head-label">
	                                    <button type="button" class="btn btn-danger">London</button>
	                                </div>
	                                <div class="mt-head-user">
	                                    <div class="mt-head-user-img">
	                                        <img src="{{asset('themes/metronic/pages/img/avatars/team3.jpg')}}"> </div>
	                                    <div class="mt-head-user-info">
	            ...
	            <div class="portlet-body">
	                <div class="row">
	                    <div class="col-md-4">
	                        <div class="mt-widget-4">
	                            <div class="mt-img-container">
	                                <img src="{{asset('themes/metronic/pages/img/background/34.jpg')}}" /> </div>
	                    ...
	                    <div class="col-md-4">
	                        <div class="mt-widget-4">
	                            <div class="mt-img-container">
	                                <img src="{{asset('themes/metronic/pages/img/background/46.jpg')}}" /> </div>
	                    ...
	                    <div class="col-md-4">
	                        <div class="mt-widget-4">
	                            <div class="mt-img-container">
	                                <img src="{{asset('themes/metronic/pages/img/background/37.jpg')}}" /> </div>
